...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { availability: @shirt.availability, description: @shirt.description, name: @shirt.name, price: @shirt.price, tailor: @shirt.tailor }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { availability: @shirt.availability, description: @shirt.description, name: @shirt.name, price: @shirt.price, tailor: @shirt.tailor }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
